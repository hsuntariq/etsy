...
<body>
    ...
    displayMessage('duplicate_entry', 'red');
    ...
    <div class="row min-vh-100 overflow-y-hidden">
        ...
        <div class="col-md-3 min-vh-100 d-flex flex-column justify-content-center">
            <form action="./register-user.php" method="POST" class="p-2">
                ...
                <input name="username" type="text" placeholder="Enter username..." class="p-3 form-control w-100 my-2">
                <input name="email" type="email" placeholder="Enter email..." class="p-3  form-control w-100 my-">
                <input name="password" type="password" placeholder="Enter password..."
                    class="p-3 form-control w-100 my-2">

                <div class="d-flex align-items-center gap-2">
                    <input checked value="true" type="checkbox" name="consent" id="">
                ...
                <p class="text-secondary">
                    Already have an account <a href="/signIn.php" class="text-orange text-decoration-none">
                        Sign in instead</a>
                </p>
